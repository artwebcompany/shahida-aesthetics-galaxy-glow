          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen">
            <div className={`space-y-8 ${isVisible ? 'animate-fade-in-left' : 'opacity-0'}`}>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button className="bg-white/10 backdrop-blur-md text-white px-8 py-4 rounded-lg font-semibold border border-white/20 hover:bg-white/20 transition-all duration-300">
                  View Services
                </button>
              </div>
            ...
            <div className={`relative ${isVisible ? 'animate-fade-in-right' : 'opacity-0'}`}>
              <div className="relative bg-gradient-to-br from-emerald-500/30 to-emerald-700/30 backdrop-blur-md rounded-3xl p-8 border border-emerald-400/20">
                <img
              ...
              <div className="absolute -top-6 -right-6 bg-gradient-to-r from-emerald-600 to-emerald-500 p-4 rounded-full animate-float">
                <Star className="w-8 h-8 text-white" />
              </div>

              <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-emerald-700 to-emerald-600 p-4 rounded-full animate-float" style={{ animationDelay: '1s' }}>
